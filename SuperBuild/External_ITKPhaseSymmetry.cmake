...
# Sanity checks
if(DEFINED ITKPhaseSymmetry_DIR AND NOT EXISTS ${ITKPhaseSymmetry_DIR})
  message(FATAL_ERROR "ITKPhaseSymmetry_DIR [${ITKPhaseSymmetry_DIR}] variable is defined but corresponds to nonexistent directory")
endif()
...
if(NOT DEFINED ${proj}_DIR AND NOT ${SUPERBUILD_TOPLEVEL_PROJECT}_USE_SYSTEM_${proj})
  ...
  ExternalProject_SetIfNotDefined(
    ...
    "${EP_GIT_PROTOCOL}://github.com/KitwareMedical/ITKPhaseSymmetry.git"
    QUIET
    )
